...
import { DirectiveNode, FieldDefinitionNode, ObjectTypeDefinitionNode, InterfaceTypeDefinitionNode, ObjectTypeExtensionNode } from 'graphql';
...
export declare class AuthTransformer extends TransformerAuthBase implements TransformerAuthProvider {
    ...
    field: (parent: ObjectTypeDefinitionNode | InterfaceTypeDefinitionNode | ObjectTypeExtensionNode, field: FieldDefinitionNode, directive: DirectiveNode, context: TransformerSchemaVisitStepContextProvider) => void;
