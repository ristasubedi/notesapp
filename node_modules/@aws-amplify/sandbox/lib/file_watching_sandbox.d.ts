...
export declare class FileWatchingSandbox extends EventEmitter implements Sandbox {
     ...
     */
    constructor(backendIdSandboxResolver: BackendIdSandboxResolver, executor: AmplifySandboxExecutor, ssmClient: SSMClient, functionsLogStreamer: LambdaFunctionLogStreamer, printer: Printer, open?: typeof _open, subscribe?: typeof _subscribe);
    /**
     * @inheritdoc
     */
